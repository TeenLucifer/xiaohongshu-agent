...
- [ ] skills 扫描测试
- [ ] workspace 覆盖 builtin 测试
- [ ] frontmatter 解析测试
- [ ] requirement 检查测试
- [ ] 缺失依赖描述测试
- [ ] skills summary 生成测试
- [ ] 不可用 skill 仍出现在 summary 中的测试
- [ ] `always skills` 识别测试
- [ ] `load_skills_for_context(...)` 去 frontmatter 测试
- [ ] 指定 skill 加载测试
